...
void	copy_colone(char tab[5][9], int **cash, maxsize tab_size)
{
	int	i;
...
void	copy_ligne(char tab[5][9], int **cash, maxsize tab_size)
{
	char	obst;
	char	vide;
	int		i;
...
void	solve(char tab[5][9], int **cash, maxsize tab_size)
{
	int	y;
	int	x;
...
position	table_check(char tab[5][9], int **cash, maxsize tab_size)
{
	int			x;
	int			y;
	position	pos;
...
void	new_tab(char tab[5][9], position pos, maxsize tab_size)
{
	int	x;
	int	y;
	int	limit_x;
