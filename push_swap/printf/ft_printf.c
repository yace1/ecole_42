...
/*   Updated: 2021/12/02 12:18:42 by ybentaye         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	return_arg(char c, va_list	lst_arg)
{
	...
	i = 0;
	if (c == 'c')
		i = ft_putchar_fd2(va_arg(lst_arg, int), 1);
	else if (c == 's')
		i = ft_putstr_fd2(va_arg(lst_arg, char *), 1);
	else if (c == 'i')
		i = ft_putnbr_fd2(va_arg(lst_arg, int), 1);
	else if (c == 'd')
		i = ft_putnbr_fd2(va_arg(lst_arg, int), 1);
	else if (c == 'u')
